...
def get_pp(T, rho):
    """
    Calculate energy generated by pp chain
    ...
    -------
    float
        pp chain energy generated in g cm^2 s^-2 (erg)
    """
...
def get_cno(T, rho):
    """
    Calculate energy generated by cno cycle
    ...
    -------
    float
        cno cycle energy generated in g cm^2 s^-2 (erg)
    """
    T9 = T/1e9
    # g factor
